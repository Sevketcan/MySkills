...
- Actual player build → `build_player` or [unity-skills-cli-bridge](../unity-skills-cli-bridge/SKILL.md).
...
Running these headless avoids the main-thread blocking problem entirely — see [unity-skills-cli-bridge](../unity-skills-cli-bridge/SKILL.md). Installation has no parameterless menu method; it must go through the Installer window.
